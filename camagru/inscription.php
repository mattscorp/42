               ...
               if(filter_var($mail, FILTER_VALIDATE_EMAIL)) {
                  ...
                  if($mailexist == 0) {
                     if($passw == $passw2) {
                        ...
                        $header='From:"Camagru.com"<42betatest@gmail.com>'."\n";
                        $header='Conten-Type:text/html; charset="utf-8"'."\n";
                        $header='Content-Transfert-Encoding: 8bit';
                        $message='<html><body><div><a href="http://localhost:8888/confirmation.php?pseudo='.urlencode($pseudo).'&key='.$key.'">CONFIRMATION DE VOTRE E MAIL</a></div></body></html>';
