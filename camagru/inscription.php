               ...
               if(filter_var($mail, FILTER_VALIDATE_EMAIL)) {
                  ...
                  if($mailexist == 0) {
                     if($passw == $passw2) {
                        ...
                        $header='From:"Camagru.com"<mascorpi@student.42.fr>'."\n";
                        ...
                        <body>
                           <div>
                           <a href="http://localhost:8888/confirmation.php?pseudo='.urlencode($pseudo).'&key='.$key.'">CONFIRMATION DE VOTRE E MAIL</a>
                           </div>
                        </body>
                        </html>
                        ';
